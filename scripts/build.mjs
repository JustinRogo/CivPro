...
await write(output+'/manifest.webmanifest',{id:site.pathname,name:'Federal Civil Rules',short_name:'Civil Rules',description:'Federal civil rules and source documents for all 94 districts.',start_url:site.pathname+'#/',scope:site.pathname,display:'standalone',background_color:'#f6f3ec',theme_color:'#071525',icons:[{src:'icon-192.png',sizes:'192x192',type:'image/png'},{src:'icon-512.png',sizes:'512x512',type:'image/png',purpose:'any maskable'}]});
